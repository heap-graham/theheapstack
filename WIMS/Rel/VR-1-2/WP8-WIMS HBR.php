...
<html lang="en">
    <head>
        ...
        <title>WIMS - Human Biology Research</title>

        <meta name="description" content="Know Thyself. Measure. Learn. Adapt." />

        <meta property="og:title" content="WIMS - Human Biology Research" />
    ...
    <body>
        ...
        <main>
            ...
            <img src="images/HBR-1.2.png" alt="Human Biology Research" />
