...
<html lang="en">
    <head>
        ...
        <title>WIMS - About WIMS</title>

        <meta name="description" content="Know Thyself. Measure. Learn. Adapt." />

        <meta property="og:title" content="WIMS - About WIMS" />
    ...
    <body>
        ...
        <main>
            ...
            <h2>About the Weight Insight Mentoring Service (WIMS)</h2>
            
                <img src="images/P0.png" alt="WIMS Service" />
                <img src="images/P1.png" alt="WIMS Service" />
                <img src="images/P2.png" alt="WIMS Service" />
                <img src="images/P3.png" alt="WIMS Service" />
                <img src="images/P4.png" alt="WIMS Service" />
                <img src="images/P5.png" alt="WIMS Service" />
